              ...
              <> 
                ...
                >
                  <div className="bg-input px-2 py-1 rounded-b-lg">
                    ...
                    {
                      type === "Promotores" && 
                      <div className="rounded-lg px-2 pb-2">
                        <table className="w-full text-sm">
                          <thead>
                            <tr className="text-text-inactive border-b border-inactive/30">
                              <th className="text-left py-2 px-1 font-medium">Promotores</th>
                              <th className="text-center py-2 px-1 font-medium">Vendidas</th>
                              <th className="text-right py-2 px-1 font-medium">Acciones</th>
                            </tr>
                          </thead>
                          <tbody>
                            {
                              selectedEvent?.promoters?.map((promoter) => (
                                <tr key={promoter.userId} className="border-b border-inactive/10 last:border-0">
                                  <td className="py-2.5 px-1">
                                    <span className="text-primary-white">{promoter?.name}</span>
                                  </td>
                                  <td className="py-2.5 px-1 text-center">
                                    <span className="text-primary-white font-medium">{promoter?.promoter?.totalTickets ?? 0}</span>
                                  </td>
                                  <td className="py-2.5 px-1">
                            ...
                            }
                            {
                              ...
                              <tr>
                                <td colSpan={3} className="text-center pt-3 pb-6 text-text-inactive">
