...
import { useAdminPromoterBinnacles, useServeMovementImage } from "@/hooks/admin/queries/useAdminData";
    ...
    <div className="w-full flex flex-col justify-between bg-primary-black text-primary-white min-h-screen p-4 pb-40 sm:pt-32">
      <div>
        ...
        <div className="max-w-xl pt-24 mx-auto animate-fade-in space-y-2">
          ...
          <div className="flex flex-col items-start justify-center">
            <h3 className="text-sm text-text-inactive">Concepto</h3>
            <h2 className="text-lg font-medium">{selectedMovement?.reference ?? "Concepto"}</h2>
          </div>
          <div className="flex flex-col items-start justify-center">
          ...
          <div className="flex flex-col items-start justify-center">
            ...
            <div className="px-5 flex w-full" >
              ...
              }
              {
                ...
                <div className="w-full max-w-[400px] h-[400px] flex items-center justify-center bg-main-container rounded-md">
