...
const NavbarMobile: React.FC = () => {
  ...
  return (
    <nav className={`${pathname.startsWith("/checker") && "hidden"} ${!pathname.startsWith("/admin") && "md:hidden"} fixed bottom-0 left-0 right-0 rounded-t-[35px] bg-main-container px-2 py-2 pb-7 z-20`}>
