...
const NavbarMobile: React.FC = () => {
  ...
  return (
    <nav
      className={`${isChecker || isAdminAuth ? "hidden" : ""} ${isSpecialPath ? "" : "lg:hidden"} fixed bottom-0 left-0 right-0 rounded-t-[35px] bg-main-container px-2 pt-1 pb-3 z-20`}
    >
            ...
            item.id === "home"
              ...
              : item.id === "auth"
                ...
                : item.id === "tickets"
                  ...
                  : item.href === "/organizer"
                    ? pathname === "/organizer" ||
                      /^\/organizer\/event\/\d+/.test(pathname)
                    : item.href === "/promoter"
                      ? pathname === "/promoter" ||
                        /^\/promoter\/event\/\d+/.test(pathname)
