...
export function useCreateOrganizerFreeEvent({reset, successHref = "/admin/events", errorHref = "/admin/events"}: {reset: (data: IEventFormData) => void, successHref?: string, errorHref?: string}) {
